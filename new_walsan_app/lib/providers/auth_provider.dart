...
class AuthProvider with ChangeNotifier {
  ...
  try {
    ...
    _setLoading(false);
    _setError(e.toString()); // e sudah berupa String murni dari service
    return false;
  }
  ...
  Future<void> _saveSession(LoginResponse response) async {
    try {
      ...
      await prefs.setString('namaAyah', response.namaAyah);
      await prefs.setString('namaIbu', response.namaIbu);
