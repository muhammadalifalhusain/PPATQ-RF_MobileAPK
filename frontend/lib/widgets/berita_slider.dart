  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      itemBuilder: (context, index, realIndex) {
        ...
        final String isiBeritaRaw = (berita.isiBerita.trim().isNotEmpty)
          ? berita.isiBerita
          : '';
        final String isiBeritaText = html_parser.parse(isiBeritaRaw).body?.text ?? '';
        ...
        child: Container(
          ...
          children: [
            ...
            const SizedBox(height: 6), // Reduce bottom space to help prevent overflow
          ],
          ),
        ),
        );
