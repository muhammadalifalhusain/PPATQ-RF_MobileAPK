  ...
  List<Widget> _buildExpandableData() {
    ...
    return tahunList.map((tahun) {
      ...
      return Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: isYearExpanded ? Colors.red.shade50 : Colors.grey.shade50,
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: isYearExpanded ? Colors.red.shade200 : Colors.grey.shade200,
              width: 1.5,
            ),
            boxShadow: [
              BoxShadow(
          ...
          child: Theme(
            ...
            child: ExpansionTile(
              ...
              leading: Container(
                ...
                decoration: BoxDecoration(
                  color: isYearExpanded ? Colors.red.shade400 : Colors.grey.shade400,
              ...
              title: Text(
                ...
                style: GoogleFonts.poppins(
                  fontSize: 17,
                  fontWeight: FontWeight.w600,
                  color: isYearExpanded ? Colors.red.shade700 : Colors.grey.shade700,
                ),
              ),
              trailing: Icon(
                isYearExpanded ? Icons.expand_less : Icons.expand_more,
                color: isYearExpanded ? Colors.red.shade600 : Colors.grey.shade600,
              ),
              ...
              children: bulanList.map((bulan) {
                ...
                return Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: isMonthExpanded ? Colors.orange.shade50 : Colors.white,
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                        color: isMonthExpanded ? Colors.orange.shade200 : Colors.grey.shade200,
                        width: 1,
                      ),
                    ),
                    child: Theme(
                      ...
                      child: ExpansionTile(
                        ...
                        leading: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isMonthExpanded ? Colors.orange.shade100 : Colors.grey.shade100,
                            borderRadius: BorderRadius.circular(6),
                          ),
                          child: Icon(
                            Icons.date_range,
                            color: isMonthExpanded ? Colors.orange.shade600 : Colors.grey.shade600,
                            size: 18,
                          ),
                        ),
                        title: Text(
                          ...
                          style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 15,
                            color: isMonthExpanded ? Colors.orange.shade700 : Colors.grey.shade800,
                          ),
                        ),
                        trailing: Icon(
                          isMonthExpanded ? Icons.remove_circle_outline : Icons.add_circle_outline,
                          color: isMonthExpanded ? Colors.orange.shade600 : Colors.grey.shade500,
                          size: 20,
                        ),
                        onExpansionChanged: (expanded) {
                          setState(() {
